...
public class CSVFileProcessor extends AbstractFileProcessor {
	...
	CSVFileProcessor(final File serverSideFile, final ApplicationCommittedListener listener,
			final ProgressIndicator progressIndicator, final Label verboseProgressLabel, final CSVFormat csvFormat,
