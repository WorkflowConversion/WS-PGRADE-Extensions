package com.workflowconversion.importer.db.config;

/**
 * Interface to obtain database configuration values. Implementations can decide whether to take these values from a
 * properties file, hardcode them or get them via the gUSE webservices.
 * 
 * @author delagarza
 *
 */
