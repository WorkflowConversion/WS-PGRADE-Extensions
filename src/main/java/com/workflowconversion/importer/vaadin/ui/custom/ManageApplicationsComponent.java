...
import com.workflowconversion.importer.vaadin.ui.custom.apptable.ApplicationsViewComponent;
...
public class ManageApplicationsComponent extends CustomComponent {
	 ...
	 * Constructor.
	 */
	public ManageApplicationsComponent() {
	...
	private void initLeftSide() {
		...
		final Collection<ApplicationProvider> applicationProviders = Settings.getInstance().getApplicationProviders();
		...
		for (final ApplicationProvider applicationProvider : applicationProviders) {
			...
			final ApplicationsViewComponent applicationsView = new ApplicationsViewComponent(applicationProvider,
					applicationProvider.isEditable());
